...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：系列教程&nbsp;&nbsp;>&nbsp;&nbsp;管理系列&nbsp;&nbsp;>&nbsp;&nbsp;管理教程</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">标题</th>
  		<th align="center" valign="middle" class="borderright">阅读数量</th>
...
/*	$pageCount = 6;
	...
	$totalPageSQL = "select count(*) as count from sets";
	$totalCount = mysqli_fetch_assoc(mysqli_query($con,$totalPageSQL))['count'];
	...
	$pageCount=8;
	/////////////////////////////////////////////////
		$SQL1="select * from sets where id={$_GET['id']}";
	  ...
	  <?php
		$SQL2="select * from article where sid={$row1['id']} and isSet=1";
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <td align="center" valign="middle" class="borderright borderbottom"><a href="message_info.html" target="mainFrame" onFocus="this.blur()"></a></td>
	    <td align="center" valign="middle" class="borderright borderbottom"><?= date('Y-m-d H:i:s',$row2['ptime'])?></td>
	    <td align="center" valign="middle" class="borderbottom"><a href="update_article.php?sid=<?= $row1['id']?>&id=<?= $row2['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span><a href="delete_article.php?sid=<?= $row1['id']?>&id=<?= $row2['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
	  </tr>
	  <?php
	  }
	  ?>
