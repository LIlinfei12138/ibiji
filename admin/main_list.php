...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：系列教程&nbsp;&nbsp;>&nbsp;&nbsp;分类管理</td>
  </tr>
  <!-- <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="update_sortName.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改分类</a><span class="gray">&nbsp;|&nbsp;</span><a href="./deletesort.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除分类</a><span class="gray">&nbsp;|&nbsp;</span><a href="main_message.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">查看系列</a></td>
      </tr>
	  <?php
	  }
	  ?>
