...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：工具推荐&nbsp;&nbsp;>&nbsp;&nbsp;管理工具</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	  ...
	  <?php
		$SQL1="select * from toolCategory where id={$_GET['id']}";
	  ...
	  <?php
		$SQL2="select * from tools where cid={$row1['id']}";
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <td align="center" valign="middle" class="borderright borderbottom"><a href="message_info.html" target="mainFrame" onFocus="this.blur()"><?= date('Y-m-d H:i:s',$row2['time'])?></a></td>
	    <td align="center" valign="middle" class="borderbottom"><a href="update_tool.php?id=<?= $row2['id']?>&cid=<?= $row2['cid']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span><a href="delete_tool.php?id=<?= $row2['id']?>&cid=<?= $row2['cid']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
	  </tr>
	  <?php
	  }
	  ?>
