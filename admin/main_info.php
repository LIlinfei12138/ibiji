...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：系列教程&nbsp;&nbsp;>&nbsp;&nbsp;添加系列</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">新增系列</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="add_series.php" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <td align="left" valign="middle" class="borderright borderbottom main-for">
	    <input type="text" name="series" value="" class="text-word">
	    </td>
	   </tr>
	   <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	     <td align="right" valign="middle" class="borderright borderbottom bggray">难度等级</td>
	     <td align="left" valign="middle" class="borderright borderbottom main-for">
			 <input id="ND-one" type="radio" name="nandu" value="1" />
			 <label for="ND-one">★</label>
			 <input id="ND-two" type="radio" name="nandu" value="2" />
			 <label for="ND-two">★★</label>
			 <input id="ND-three" type="radio" name="nandu" value="3" />
			 <label for="ND-three">★★★</label>
			 <input id="ND-four" type="radio" name="nandu" value="4" />
		 ...
		 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		  ...
		  <td align="left" valign="middle" class="borderright borderbottom main-for">
		  <input type="file" multiple name="photofile" class="text-word">
		  </td>
		 </tr>
		<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		  ...
		  <td align="left" valign="top" class="borderright borderbottom main-for">
			<textarea name="jianjie" class="jianjie"></textarea>
		  </td>
		</tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
