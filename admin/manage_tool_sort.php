...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：工具推荐&nbsp;&nbsp;>&nbsp;&nbsp;管理分类</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="update_tool_sortName.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改分类</a><span class="gray">&nbsp;|&nbsp;</span><a href="./delete_tool_sort.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除分类</a><span class="gray">&nbsp;|&nbsp;</span><a href="manage_tool.php?id=<?= $row['id']?>" target="mainFrame" onFocus="this.blur()" class="add">查看工具</a></td>
      </tr>
	  <?php
	  }
	  ?>
