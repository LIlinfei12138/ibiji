...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：&nbsp;&nbsp;管理系列&nbsp;&nbsp;>&nbsp;&nbsp;管理教程&nbsp;&nbsp;>&nbsp;&nbsp;修改</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">修改文章</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="./doupdate_article.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">修改选择系列：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="select_series">
			<?php
				$sid=$_GET['sid'];
				$id=$_GET['id'];
				...
				while ($row=mysqli_fetch_assoc($res)){
					$ID=$row['id'];
			?>
	    <option <?= optionSel($ID,$sid)?> value="<?= $row['id']?>" >&nbsp;&nbsp;<?= $row['name']?></option>
		<?php
		}
		?>
        </select>
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    <td align="right" valign="middle" class="borderright borderbottom bggray">修改文章标题：</td>
	    <td align="left" valign="middle" class="borderright borderbottom main-for">
	    <input type="text" name="title" value="<?= $row2['title']?>" class="text-word">
	    </td>
	   </tr>
		<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		  <td align="right" class="borderright borderbottom bggray">修改文章内容</td>
