...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：系列教程&nbsp;&nbsp;>&nbsp;&nbsp;管理系列</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">难度等级</th>
	  ...
	  $start=($nowPage - 1) * $pageCount;
		//$SQL1="select * from setCategory limit {$start},{$pageCount}";
	  ...
	  <?php
		$SQL2="select * from sets where cid={$row1['id']}";
		$res2=mysqli_query($con,$SQL2);
		while($row2=mysqli_fetch_assoc($res2)){
			$row2['ilevel']=intval($row2['ilevel']);
			$star=$row2['ilevel'];
			$star=str_repeat('★',$star);
	  ?>
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    <td align="center" valign="middle" class="borderright borderbottom"><img src="./images/main/dirsecond.gif" /></td>
	    <td align="center" valign="middle" class="borderright borderbottom"><?= $row2['name']?></td>
	    ...
	    <td align="center" valign="middle" class="borderright borderbottom"><?= $star?></td>
	    <td align="center" valign="middle" class="borderbottom"><a href="manage_course.php?id=<?= $row2['id']?>&cid=<?= $row2['cid']?>" target="mainFrame" onFocus="this.blur()" class="add">管理教程</a><span class="gray">&nbsp;|&nbsp;</span><a href="update_series.php?id=<?= $row2['id']?>&oldCid=<?= $row2['cid']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span><a href="delete_series.php?id=<?= $row2['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
	  </tr>
	  <?php
	  }
	  ?>
